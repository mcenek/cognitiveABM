...
public static class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        foreach (string terrainFilePath in terrainFilePaths)
        {
            ...
            HillClimberFCM fcm = new HillClimberFCM(population: 96, numberOfValues: 1701, STEPS, OUTPUT_FILENAME, FITNESS_COLUMNNAME, trainGenomes);
            ...
            fcm = new HillClimberFCM(population: 96, numberOfValues: 1701, STEPS, OUTPUT_FILENAME, FITNESS_COLUMNNAME, trainGenomes);
